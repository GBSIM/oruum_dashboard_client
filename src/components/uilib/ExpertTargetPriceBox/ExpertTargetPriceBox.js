import './ExpertTargetPriceBox.css';

export default function ExpertTargetPriceBox(props) {
    ...
    return (
        <div className='expert-target-price-box-container'>
            <div className='expert-target-price-list'>
            ...
            <div className='expert-target-price-box-vertical-line'>
                <div className='expert-target-price-circle' style={{'top':'20px','background':'#34B199'}}></div>
                <div className='expert-target-price-margin' style={{'top':'-6px','color':'#34B199'}}>{marginToHighTarget}%</div>
                <div className='expert-target-price-circle' style={{'top':'73px','background':'#EBB00C'}}></div>
                <div className='expert-target-price-margin' style={{'top':'47px','color':'#EBB00C'}}>{marginToAvgTarget}%</div>
                <div className='expert-target-price-circle' style={{'top':'116px','background':'#F15E5E'}}></div>
                <div className='expert-target-price-margin' style={{'top':'90px','color':'#F15E5E'}}>{marginToLowTarget}%</div>

                <div className='expert-current-price-container' style={{'top': currentPricePosition}}>
                    <div className='expert-current-price-line'></div>
...
function CurrentPrice(props) {
    return (
        <div className="expert-target-price-container" style={{'top':props.topPosition,'marginBottom':'20px','marginLeft':'10px'}}>
            <div className="expert-target-price-title">{props.title}</div>
            <h1 className="expert-target-price-value" style={{'color':'#696969'}}>{props.value}</h1>
        </div>
    )
}
...
function TargetPrice(props) {
    return (
        <div className="expert-target-price-container" style={{'top':props.topPosition}}>
            <div className="expert-target-price-title">{props.title}</div>
            <h1 className="expert-target-price-value" style={{'color':props.color}}>{props.value}</h1>
        </div>
    )
}