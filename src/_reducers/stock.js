...
const initialState = {
  ...
  quarterGrossProfitList: [10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,],
  quarterOperatingIncomeList: [10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,],
  quarterNetIncomeList: [10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,],

  quarterAssetList: [10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,],
  quarterLiabilitiesList: [10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,],
  quarterEquityList: [10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,],
  quarterCurrentAssetList: [10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,],
  quarterCurrentLiabilitiesList: [10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,],

  quarterOperatingCashFlowList: [10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,],
  quarterInvestingCashFlowList: [10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,],
  quarterFinancingCashFlowList: [10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,],
  quarterNetChangeCashFlowList: [10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,],

  quarterDividendList: [10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,],
  dividendUnit: "달러",
};
